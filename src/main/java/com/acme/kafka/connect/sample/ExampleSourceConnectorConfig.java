...
public class ExampleSourceConnectorConfig extends AbstractConfig {
    public ExampleSourceConnectorConfig(final Map<?, ?> originalProps) {
    ...
    private static final String MONITOR_THREAD_TIMEOUT_DOC = "Timeout used by the monitorinng thread";
